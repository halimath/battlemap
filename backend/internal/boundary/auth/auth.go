...
func UserID(ctx echo.Context) (string, bool) {
...
func (p *provider) CreateToken() (string, error) {
	return p.createToken(uuid.New().String())
}

func (p *provider) createToken(userID string) (string, error) {
...
func (p *provider) Authorize(tokenString string) (string, error) {
...
func (p *provider) authorize(tokenString string, verifier ...jwt.Verifier) (string, error) {
